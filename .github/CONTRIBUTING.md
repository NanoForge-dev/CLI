...
4. Make your changes
5. Run `pnpm format && pnpm build && pnpm test:unit` to run ESLint/Prettier, build and tests
6. [Submit a pull request](https://github.com/NanoForge-dev/CLI/compare) (Make sure you follow the [conventional commit format](https://github.com/NanoForge-dev/CLI/blob/main/.github/COMMIT_CONVENTION.md))
